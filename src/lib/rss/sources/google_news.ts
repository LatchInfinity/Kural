...
export const googleNewsTamilFeeds: RSSSourceConfig[] = [
  ...
  googleNewsSearch("google-news-tamil-nadu-technology", "Google News Tamil Nadu Technology", "கூகுள் தொழில்நுட்ப செய்திகள்", "Tamil Nadu technology startup IT AI Chennai Coimbatore", "technology"),
  ...
  googleNewsSearch("google-news-tamil-nadu-accident", "Google News Tamil Nadu Accident", "கூகுள் விபத்து செய்திகள்", "Tamil Nadu accident crash fire சாலை விபத்து", "accident"),
